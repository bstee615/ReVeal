...
python Devign/main.py --model_type ggnn --dataset "$name" --input_dir "$outpdir/data/ggnn_input/$name/" --model "$outpdir/data/models/$name/GGNNSumModel.bin" --feature_size 169 --patience 100 || exit 1;
