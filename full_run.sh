...
python ../Devign/run_model.py --model "models/$name/GGNNSumModel-model.bin" --dataset "$outpdir/ggnn_input/processed.bin" --output_dir "$outpdir/after_ggnn" --name "$name";
